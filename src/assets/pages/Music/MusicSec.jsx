...
export default function Home() {
  ...
  const play = async () => {
    ...
    // const planeMaterial = new THREE.MeshNormalMaterial({ wireframe: true, color: 0xffff00 });
    // const sphere = new THREE.Mesh( planeGeometry, planeMaterial ); scene.add( sphere );
    ...
    planeMesh.rotation.x += -Math.PI / 50 + Math.PI / 100;
    planeMesh.scale.x = 2;
    planeMesh.scale.y = 2;
    planeMesh.scale.z = 3;
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="absolute bottom-2 left-2 blue-gradient_text"><h6>You can move the visual around</h6></div>
