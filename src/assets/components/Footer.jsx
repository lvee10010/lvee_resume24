      ...
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2 classic-footer">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
